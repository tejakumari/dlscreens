        ...
        <div>
            ...
            <div>
               ...
               <div>
                   ...
                   <hr class="w-28 ml-16 relative bottom-4 border-2 border-blue-500"></hr>
                   <hr class="ml-16 relative bottom-4 border border-gray-500" style={{width:800}}></hr>
                   ...
                   <button class="text-white text-xs w-52 p-4 rounded-tr-3xl bg-yellow-500 ml-32 rounded-l-3xl relative bottom-24 left-32" style={{marginLeft:904}}>Have a doubt?Rise a query</button>
                   <img src="./assets/images/greendot.png" class="w-2 relative bottom-32 left-10" style={{marginLeft:900}}></img>
               </div>
        </div>
    )
}