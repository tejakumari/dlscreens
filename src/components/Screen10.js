    ...
    return (
        ...
        <div>
           ...
           <div class="clear-left relative top-8">
               ...
               <hr class="border-2 border-blue-500 w-24 ml-96 relative left-64 top-4"></hr>
               <hr class="mt-4"></hr>
           </div><br></br><br></br>
           <div>
           ...
           <button class="text-white text-xs w-52 p-4 rounded-tr-3xl bg-yellow-500 rounded-l-3xl relative bottom-20" style={{marginLeft:904}}>Have a doubt?Rise a query</button>
               <img src="./assets/images/greendot.png" class="w-6 h-6 relative bottom-28" style={{marginLeft:900}}></img>
    </div>
        </div>
    )
}
