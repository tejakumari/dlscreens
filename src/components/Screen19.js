...
function Screen19() {
    return (
       ...
       <div style={{width:200,height:250}} class="border-2 bg-white float-left border-gray-300 rounded-xl drop-shadow-3xl ml-20 relative bottom-10">
           ...
           <img src="./assets/images/img99.png" class="mt-32 relative right-2" style={{width:200,height:200}}/>
       </div>
       <div style={{width:700,height:600}} class="border-2 bg-white float-left border-gray-300 rounded-xl drop-shadow-3xl ml-32 relative bottom-10">
           <img src="./assets/images/user.png" class="w-20 ml-12 mt-10"></img>
