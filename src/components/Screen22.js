    ...
    return (
        <div style={{height:300}}>
            ...
            <img src="./assets/images/img1.png" class="mt-6 ml-32"></img>
                ...
                <img src="./assets/images/bell.png" style={{marginLeft:1050}} class="relative bottom-16"></img>
            ...
            <div style={{width:200,height:250}} class="border-2 bg-white float-left text-gray-500 border-gray-300 rounded-xl drop-shadow-2xl ml-20 relative bottom-10">
                ...
                <img src="./assets/images/Pad1.png" class="mt-32 relative right-4"></img>
            ...
            <div style={{width:700,height:350}} class="border-2 bg-white float-left border-gray-300 rounded-xl drop-shadow-2xl ml-32 relative bottom-10">
                <img src="./assets/images/aws.jpg" class="w-36 ml-20 mt-10"></img>
                ...
                <p  class="ml-96 relative  bottom-28 text-gray-800">Total Amount Payed : ₹ 34,999.00</p>
                ...
                <img src="./assets/images/python.jpg" class="w-36 ml-20 mt-10"></img>
