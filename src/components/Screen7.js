...
const Screen7 = () => {
    return (
        ...
        <div>
           ...
           <div>
               <img src="./assets/images/user.png" class="ml-20"></img>
               ...
               <img src="./assets/images/user.png" class="ml-40"></img>
               ...
               <img src="./assets/images/user.png" class="ml-40 relative top-2"></img>
               ...
               <p class="ml-36 relative bottom-8 text-gray-500">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor <br></br>
                invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et</p>
               <button class="text-white text-xs w-52 p-4 rounded-tr-3xl bg-yellow-500 ml-32 rounded-l-3xl relative bottom-20" style={{marginLeft:804}}>Have a doubt?Rise a query</button>
               <img src="./assets/images/greendot.png" class="w-6 h-6 relative bottom-28" style={{marginLeft:800}}></img>
