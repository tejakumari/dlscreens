...
function Screen23(props) {
    return (
        ...
        <div>
       <img src="./assets/images/img1.png" class="mt-6 ml-32"/>
           <h1 style={{marginLeft:900}} class="relative bottom-8"><u>My Class Room</u></h1>
           <img src="./assets/images/bellicon.png" style={{marginLeft:1050}} class="relative bottom-16"/>
           <img src="./assets/images/user.png" style={{marginLeft:1120}} class="relative bottom-24 w-8"/>
       ...
       <div style={{width:200,height:250}} class="border-2 bg-white float-left text-gray-500 border-gray-300 rounded-xl drop-shadow-2xl ml-20 relative bottom-10">
           ...
           <img src="./assets/images/img99.png" class="mt-32 relative right-4" style={{width:200,height:200}}/>
