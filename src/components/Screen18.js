...
export default function Screen18() {
    return (
        <div>
            ...
            <button class="w-36 p-1 text-white relative bottom-10 bg-blue-500" style={{marginLeft:900}}>Join Class</button>
            </div>
            <div>
               ...
               <div>
                   ...
                   <img src="./assets/images/greendot.png" class="w-6 h-6 relative bottom-48 left-52" style={{marginLeft:800}}></img>
               </div>
               <div class="ml-96 relative left-96  bg-gray-100 bottom-52" style={{width:250,height:100,position:"relative",bottom:1200,left:590}}>
                ...
                <img src="./assets/images/Signout.png" class="w-8 bg-gray-500 mt-2 ml-2"></img>
