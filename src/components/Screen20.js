...
function Screen20() {
    return (
       ...
       <div style={{width:200,height:250}} class="border-2 bg-white float-left text-gray-500 border-gray-300 rounded-xl drop-shadow-2xl ml-20 relative bottom-10">
           ...
           <img src="./assets/images/img99.png" class="mt-32 relative right-2" style={{width:200,height:200}}></img>
       ...
       <div style={{width:700,height:350}} class="border-2 bg-white float-left border-gray-300 rounded-xl drop-shadow-2xl ml-32 relative bottom-10">
           <input type="text" placeholder="Old Password" class="border border-t-0 border-r-0 border-l-0 ml-8 p-2 text-sm mt-14" style={{width:500}}></input><br></br>
           <input type="text" placeholder="New Password" class="border border-t-0 border-r-0 border-l-0 ml-8 p-2 text-sm mt-8" style={{width:500}}></input><br></br>
           <input type="text" placeholder="Confirm Password" class="border border-t-0 border-r-0 border-l-0 ml-8 p-2 text-sm mt-8" style={{width:500}}></input><br></br>
